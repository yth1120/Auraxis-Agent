...
- 单元覆盖率门槛：lines/statements ≥ 80%、branches ≥ 80%、functions ≥ 80%（`vitest.config.mts`）；最近一次全仓库分支门禁报告为 89.66% statements / 92.00% lines / 81.00% branches / 88.17% functions，四项均已达标。
