...
- 单元覆盖率门槛：lines/statements ≥ 80%、branches ≥ 80%、functions ≥ 80%（`vitest.config.mts`）；最近一次全仓库分支门禁报告为 89.44% statements / 91.85% lines / 80.87% branches / 88.09% functions，四项均已达标。
