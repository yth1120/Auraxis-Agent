...
- 单元覆盖率门槛：lines/statements ≥ 80%、branches ≥ 80%、functions ≥ 80%（`vitest.config.mts`）；最近一次全仓库分支门禁报告为 89.43% statements / 91.83% lines / 80.84% branches / 88.11% functions，四项均已达标。
