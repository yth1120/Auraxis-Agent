...
function latestChatToolInvocations(messages: ReturnType<typeof useChatStore.getState>['messages']): ToolInvocation[] {
...
function agentToolInvocations(agent: AgentInfo | undefined): ToolInvocation[] {
  if (!agent?.log) return [];
  return agent.log
...
function latestAgentTodos(agent: AgentInfo | undefined): RawTodo[] | null {
